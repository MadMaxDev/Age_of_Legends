...
using CMNCMD;
using STCCMD;
public class Institute : MonoBehaviour {
	//建筑状态 正常、建造、升级 
	...
	//根据服务器发来的信息初始化研究院    
	void InitialInstitute(uint level)
	{
	...
	void UpgradeBeginCountdown()
	{
		...
		{
			BuildInfo info = (BuildInfo)U3dCmn.GetBuildingInfoFromMb((int)BuildingSort.YANJIUYUAN,(int)(NowLevel+1));
