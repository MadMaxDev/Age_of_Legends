...
public:
	...
	*/
	...
	/// Load from a string (string must have a zero ending)
	bool LoadFromBuffer( char *buf, int length, TiXmlEncoding encoding );
	/// Save to a string
	bool SaveToStream( TiXmlOutStream *pS ) const;
