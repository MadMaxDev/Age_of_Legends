...
bool TiXmlDocument::LoadFile( const char* filename, TiXmlEncoding encoding )
{
	...
	if ( file )
	{
		...
		bool	bRst	= LoadFromBuffer(buf, length, encoding);
...
bool TiXmlDocument::LoadFromBuffer( char *buf, int length, TiXmlEncoding encoding )
{
...
bool TiXmlDocument::SaveToStream( TiXmlOutStream *pS ) const
{
	StreamOut(pS);
	return	true;
}
