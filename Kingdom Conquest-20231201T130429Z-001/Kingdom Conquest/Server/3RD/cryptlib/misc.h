...
#define CRYPTOPP_COMPILE_ASSERT_INFUNC(assertion) CRYPTOPP_COMPILE_ASSERT_INSTANCE_INFUNC(assertion, __LINE__)
#if defined(CRYPTOPP_EXPORTS) || defined(CRYPTOPP_IMPORTS)
#define CRYPTOPP_COMPILE_ASSERT_INSTANCE(assertion, instance)
#define CRYPTOPP_COMPILE_ASSERT_INSTANCE_INFUNC(assertion, instance)
#else
...
#define CRYPTOPP_COMPILE_ASSERT_INSTANCE_INFUNC(assertion, instance) static CompileAssert<(assertion)> CRYPTOPP_ASSERT_JOIN(cryptopp_assert_, instance); (void)CRYPTOPP_ASSERT_JOIN(cryptopp_assert_, instance);
#endif
